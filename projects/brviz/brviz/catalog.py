...
COUNTRIES = {
    ...
    "BOL": {"name": "Bolivia", "group": "latam"},
    "PRY": {"name": "Paraguay", "group": "latam"},
    "VEN": {"name": "Venezuela, RB", "group": "latam"},
    "CRI": {"name": "Costa Rica", "group": "latam"},
    "SLV": {"name": "El Salvador", "group": "latam"},
    "GTM": {"name": "Guatemala", "group": "latam"},
    "HND": {"name": "Honduras", "group": "latam"},
    "NIC": {"name": "Nicaragua", "group": "latam"},
    "PAN": {"name": "Panama", "group": "latam"},
    "CUB": {"name": "Cuba", "group": "latam"},
    "DOM": {"name": "Dominican Republic", "group": "latam"},
    "HTI": {"name": "Haiti", "group": "latam"},
...
WAVE2_INDICATORS = {
    ...
    "edu_pupil_sec": (
        "SE.XPD.SECO.PC.ZS",
        "Gov spend per secondary student (% GDP per capita)",
    ),
